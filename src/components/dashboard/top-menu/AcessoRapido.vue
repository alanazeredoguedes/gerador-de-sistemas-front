  ...
  <div class="d-flex align-items-center ms-1">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
      ...
      <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('media/misc/pattern-1.jpg')">
        <!--begin::Title-->
        <h3 class="text-white fw-semibold mb-3">Acesso Rapido</h3>
        <!--end::Title-->
        <!--begin::Status-->
        <span class="badge bg-primary py-2 px-3">25 tarefas pendentes</span>
        <!--end::Status-->
      </div>
      <!--end::Heading-->
      <!--begin:Nav-->
      <div class="row g-0">
        <!--begin:Item-->
        <div class="col-6">
          <a href="javascript:void(0)" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
        ...
        <!--begin:Item-->
        <div class="col-6">
          <a href="javascript:void(0)" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
        ...
        <!--begin:Item-->
        <div class="col-6">
          <a href="javascript:void(0)" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
        ...
        <!--begin:Item-->
        <div class="col-6">
          <a href="javascript:void(0)" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
